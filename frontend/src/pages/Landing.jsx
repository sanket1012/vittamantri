...
export default function Landing({ onGetStarted }) {
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#FFFFFF', display: 'flex', flexDirection: 'column' }}>
      <Box sx={{ px: { xs: 2.5, md: 6 }, py: 2.5, display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #E2DCC9' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          <Box sx={{ width: 40, height: 40, borderRadius: '10px', bgcolor: '#E6EFEA', color: '#173F35', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', px: { xs: 2.5, md: 6 }, py: { xs: 6, md: 10 } }}>
        <Box sx={{ maxWidth: 720, textAlign: 'center', mb: { xs: 6, md: 8 } }}>
          <Typography sx={{ fontSize: { xs: 32, md: 44 }, fontWeight: 700, color: '#202421', lineHeight: 1.15, mb: 2 }}>
            Family finances,{' '}
            <Box component="span" sx={{ color: '#173F35' }}>
              tracked together
            </Box>
          </Typography>
          <Typography sx={{ fontSize: { xs: 16, md: 18 }, color: '#6B6F63', lineHeight: 1.6, mb: 4 }}>
              ...
              <Grid item xs={12} sm={6} md={4} key={feature.title}>
                <Card variant="outlined" sx={{ borderRadius: '0.75rem', height: '100%' }}>
                  <CardContent sx={{ p: 3 }}>
                    ...
                    <Typography sx={{ fontSize: '1.0625rem', fontWeight: 600, color: '#202421', mb: 1 }}>{feature.title}</Typography>
                    <Typography sx={{ fontSize: '0.875rem', color: '#6B6F63', lineHeight: 1.6 }}>{feature.description}</Typography>
                  </CardContent>
                </Card>
              </Grid>
            );
      ...
      <Box sx={{ px: { xs: 2.5, md: 6 }, py: 3, borderTop: '1px solid #E2DCC9', textAlign: 'center' }}>
        <Typography sx={{ fontSize: '0.8125rem', color: '#9A9C90' }}>वित्तमंत्री — a personal project for tracking family finances.</Typography>
      </Box>
    </Box>
  );
}
